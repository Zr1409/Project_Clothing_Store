	...
	<div class="single_product">
		<div class="product_thumb">
			...
			<div class="product_action">
				<a id=addToCart  href="chitietsanpham?maSanPham=${param.maSanPham}"> <i class="fa fa-shopping-cart"></i> <fmt:message
						key="mnu.addcart" /></a>
			</div>
		</div>
		...
		<div class="product_info">
			<ul>
				...
				<li><a href="chitietsanpham?maSanPham=${param.maSanPham}" class="open-modal" title="Quick view"><fmt:message key="mnu.viewdetail" /></a></li>
