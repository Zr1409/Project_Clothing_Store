					...
					<div class="row">
						<div class="col-12">
							<div class="breadcrumb_content">
								<ul>
									<li><a href="index.html"> <fmt:message key="mnu.home" /></a></li>
									<li><i class="fa fa-angle-right"></i></li>
									<li><fmt:message key="mnu.changepassword" /></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<section
					...
					<div class="col col-md-8 col-lg-6 col-xxl-5">
						...
						<div class="shadow-xl p-4 p-lg-5 bg-dang">
							<h1 class="text-center fw-bold mb-5 fs-2 text-white">
								<fmt:message key="mnu.changepassword" />
							</h1>

							<form id="login-form" action="changepassword" method="POST">
								...
								<label class="form-label" for="login-email">
									<fmt:message key="mnu.diachiemail" />
									</label> <input type="email" class="form-control" id="login-email"
										name="email" placeholder="name@email.com" required>
								</div>
								<div class="form-group">
									<label for="login-password"
										class="form-label d-flex justify-content-between align-items-center">

										<fmt:message key="mnu.matkhaucu" />
									</label> <input type="password" class="form-control"
										id="login-password" name="password"
										placeholder="<fmt:message
													key="mnu.enteryourpassword" />"
										required>
								</div>
								<div class="form-group">
									<label for="login-password"
										...
										<fmt:message key="mnu.matkhaumoi" />
									</label> <input type="password" class="form-control"
										id="login-password" name="newpassword"
										placeholder="<fmt:message
													key="mnu.enteryourpassword" />"
										required>
								</div>
								<button type="submit"
									class="btn btn-dark d-block w-100 my-4 custom-button-height">
									<fmt:message key="mnu.xacnhan" />
								</button>
							</form>
						</div>
					</div>
