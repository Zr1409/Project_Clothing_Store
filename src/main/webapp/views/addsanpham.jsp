...
#preview img {
    max-width: 100px; /* Thay đổi giá trị này tùy theo kích thước mong muốn */
    max-height: 100px; /* Thay đổi giá trị này tùy theo kích thước mong muốn */
    margin-right: 10px;
    margin-bottom: 10px;
}
			...
			<div class="pos_page_inner">
				...
				<div class="container">
					...
					<div class="form-container">
						...
						<form class="addsanpham" method="post"
							...
							<div class="mb-3">
								<label for="gia" class="form-label">Giá:</label> <input
									type="number" id="gia" name="gia" class="form-control" required>
							</div>
							...
							<div class="mb-3">
								<label for="file" class="form-label">Ảnh:</label> <input
									...
									required onchange="previewImages(event)">
								<div id="preview"></div>								
								<input id="fileNames" name="fileNames"> <!-- Thay đổi từ div sang input ẩn -->
							</div>

							<div class="text-center">
								<input type="submit" name="addsanphamButton" value="Upload" formaction="addsanpham"
